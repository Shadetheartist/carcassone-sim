...
func (p Placement) TileToGridDir(direction directions.Direction) directions.Direction {
...
func (p Placement) GridToTileDir(direction directions.Direction) directions.Direction {
